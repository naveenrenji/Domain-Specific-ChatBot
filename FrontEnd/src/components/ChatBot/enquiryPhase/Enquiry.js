const parts = [
    {
      ...
      prompt: "Let's start by naming your project. Could you please tell me what your engineering design project is titled?",
      fallback: "If you're finding it challenging, think of something that describes your project's main idea or objective. For example, if your project is about creating a more efficient washing machine, you could call it 'Smart Water-Efficient Washing Machine'.",
    ...
    },
    {
      ...
      prompt: "Next, could you please give me a detailed description of your project? The more you can tell me about the problem you're trying to solve and your specific goals, the better I can understand your needs.",
    ...
    },
    {
      ...
      prompt: "Could you share your initial ideas or concepts related to the project? These insights would help me understand your thought process better.",
    ...
    },
    {
      ...
      prompt: "Finally, could you tell me about the objectives of your design project? Understanding your goals would help me tailor my recommendations and suggestions to your specific needs.",
